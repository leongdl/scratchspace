#!/bin/bash
# poll_cmd2.sh <command-id> [max-minutes] [node]
CMD="$1"; MAXMIN="${2:-30}"; NODE="${3:-mi-0c47e4d2b5454c5c5}"
...
print(d['StandardOutputContent'][:4000])
err = d['StandardErrorContent']
if err.strip(): print('--- stderr ---'); print(err[:2000])
"
